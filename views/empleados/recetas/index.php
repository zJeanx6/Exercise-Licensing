...
<body class="flex">
  ...
  <main class="p-6 w-full md:ml-64">
    <div class="flex justify-between items-center mb-4">
      ...
      <a href="<?= BASE_URL ?>views/empleados/recetas/crear.php"
            ...
            <tr class="border-b hover:bg-gray-100">
              ...
              <td class="px-4 py-2">
                <div class="inline-flex rounded-md shadow-sm" role="group">
                  <a href="<?= BASE_URL ?>views/empleados/recetas/editar.php?id=<?= $receta['id'] ?>"
                    class="px-4 py-2 text-sm font-medium text-white bg-gray-800 border border-gray-800 rounded-l-lg hover:bg-gray-900">
                    Editar
                  </a>
                  <a href="<?= BASE_URL ?>views/empleados/recetas/detalle.php?id=<?= $receta['id'] ?>"
                    class="px-4 py-2 text-sm font-medium text-white bg-green-500 border border-green-500 hover:bg-green-600">
                    Ver Detalle
                  </a>
