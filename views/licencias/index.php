...
<body class="flex">
    ...
    <main class="p-6 w-full md:ml-64">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="<?= BASE_URL ?>views/licencias/crear.php"
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <a href="editar.php?id=<?= urlencode($licencia['licencia']) ?>" class="text-blue-600 hover:underline">Editar</a>
                                <a href="eliminar.php?id=<?= urlencode($licencia['licencia']) ?>" class="text-red-600 hover:underline ml-2">Eliminar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
