...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO tipos_licencias (nombre, duracion, precio) VALUES (?, ?, ?)");
    $stmt->execute([$nombre, $duracion, $precio]);
...
<body class="flex">
    ...
    <main class="p-6 w-full md:ml-64">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold pl-10">Crear Nuevo Tipo de Licencia</h1>
